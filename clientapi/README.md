This component roughly corresponds to "Client Room Send" and "Client Sync" on [the WIRING diagram](https://github.com/neilalexander/harmony/blob/master/WIRING.md).
